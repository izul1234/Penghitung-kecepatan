 ...
 */
package aplikasiperhitungan;

/**
 *
 * @author User
 */
public class DsainPerhitungan extends javax.swing.JFrame {

    /**
     * Creates new form DsainPerhitungan
     */
    public DsainPerhitungan() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        txthasil.setText("kecepatan " + jarak/waktu);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DsainPerhitungan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DsainPerhitungan().setVisible(true);
            }
        });
    }
